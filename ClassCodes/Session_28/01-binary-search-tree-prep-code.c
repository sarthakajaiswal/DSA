/*
    @GOAL: preparation for implementing Binary Search Tree 
    @DATE: 08 Jan 2026 
...
// We are not going to use instance of this structure in this code. 
// This is here only to explain design where in struct for node and structure 
// for data structure instance are same. 
