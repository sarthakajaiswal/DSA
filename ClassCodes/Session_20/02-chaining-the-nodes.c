...
void experiment_1(void) 
{
    ...
    puts("address in first_node->next == address in second_node"); 
    puts("address in second_node->prev == address in first_node"); 
...
void experiment_2(void) 
{
    ...
    // link third node with the fourth 
    third_node->next = fourth_node; 
    fourth_node->prev = third_node; 
    fourth_node->next = NULL; 

    /* Write a code to transverse through the linked nodes in the forward direction */ 
    ...
    /* Write a code to tranverse through linked nodes in backward direction */ 
    run = fourth_node; 
    while(run != NULL) 
    {
        printf("run->data = %d\n", run->data); 
    ...
    /* Delete all nodes while traversing in backward direction */ 
