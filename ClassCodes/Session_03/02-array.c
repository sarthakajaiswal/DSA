/*
    @GOAL:  You will be given a non-empty array of integers. 
            ...
            numbers are stacked on the left side of the array and 
            all non-negative numbers are stacked on the right 
            side of the array. 
            Your job is to right shift and rotate all non-negative 
            elements. 
    @boundaty-case: There may not be any negative element, in that 
            case the entire array will be right shifted and rotated. 
